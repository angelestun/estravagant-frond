...
const ApproveCouponsComponent = () => {
    ...
    const fetchCuponesPendientes = async () => {
        ...
        try {
            const response = await axios.get('https://extravagant-back-1.onrender.com/cupones/pendientes');
    ...
    const handleApprove = async (id) => {
        ...
        try {
            await axios.put(`https://extravagant-back-1.onrender.com/cupones/aprobar/${id}`);
     ...
     const handleReject = async () => {
        ...
        try {
            await axios.put(`https://extravagant-back-1.onrender.com/cupones/rechazar/${id}`, { Motivo_Rechazo: motivo });
