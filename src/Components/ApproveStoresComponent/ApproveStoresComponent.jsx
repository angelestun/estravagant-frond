...
const ApproveStoresComponent = () => {
  ...
  const fetchTiendasPendientes = async () => {
    ...
    try {
      const response = await axios.get('https://extravagant-back-tidu.vercel.app/tiendas/pendientes');
  ...
  const fetchUsuarios = async () => {
   ...
   const handleApprove = async (id) => {
    ...
    try {
      await axios.put(`https://extravagant-back-tidu.vercel.app/tienda/aprobar/${id}`);
  ...
  const handleReject = async (id) => {
    ...
    try {
      await axios.put(`https://extravagant-back-tidu.vercel.app/tienda/rechazar/${id}`);
