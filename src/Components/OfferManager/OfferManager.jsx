...
const OfferForm = ({ onSubmit, offer, closeModal, idTienda }) => {
    ...
    useEffect(() => {
        const fetchProductos = async () => {
            try {
                const response = await axios.get(`https://extravagant-back-tidu.vercel.app/producto/tienda/${idTienda}`);
...
const OfferManager = () => {
    ...
    const fetchOffers = async () => {
        if (idTienda) {
            try {
                const response = await axios.get(`https://extravagant-back-tidu.vercel.app/oferta/tienda/${idTienda}`);
    ...
    const handleCreateOrUpdate = async (offer) => {
        ...
        try {
            ...
            const existingOffers = await axios.get(`https://extravagant-back-tidu.vercel.app/oferta/tienda/${idTienda}`);
            ...
            if (currentOffer) {
                await axios.put(`https://extravagant-back-tidu.vercel.app/ofertas/${currentOffer.ID_Oferta}`, updatedOffer);
            } else {
                await axios.post('https://extravagant-back-tidu.vercel.app/createofertas', updatedOffer);
            }
    ...
    const handleDelete = async (offerId) => {
        ...
        try {
            await axios.delete(`https://extravagant-back-tidu.vercel.app/ofertas/${offerId}`);
