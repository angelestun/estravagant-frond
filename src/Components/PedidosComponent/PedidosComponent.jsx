...
const PedidosComponent = () => {
  ...
  const fetchPedidos = async () => {
    try {
      ...
      const response = await axios.get("https://extravagant-back-1.onrender.com/pedidos/", {
  ...
  const fetchDetallesPedido = async (pedidoId) => {
    ...
    try {
      const response = await axios.get(`https://extravagant-back-1.onrender.com/pedido_producto/${pedidoId}`);
